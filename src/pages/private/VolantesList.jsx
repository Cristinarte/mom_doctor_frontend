...
export const VolantesList = ({ userId }) => {
  ...
  useEffect(() => {
    ...
    const fetchVolantes = async () => {
      ...
      try {
        ...
        const response = await axios.get("https://mom-doctor-backend-docker.onrender.com/api/medical", {
  ...
  const handleDeleteClick = async (id) => {
    ...
    try {
      ...
      await axios.delete(`https://mom-doctor-backend-docker.onrender.com/api/medical/${id}`, {
        headers: { Authorization: `Bearer ${token}` }, // Enviamos el token en el encabezado
      });
